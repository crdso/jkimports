      ...
      <section style={{padding:'48px 0'}}>
        <div style={{maxWidth:1200, margin:'0 auto', padding:'0 16px'}}>
          <div style={{marginBottom:48}}>
            ...
            <h1 style={{fontSize:40, fontWeight:700, letterSpacing:'-0.03em', lineHeight:1.05, color:'var(--site-text)', marginBottom:16}}>Fale com a JK IMPORTS.</h1>
            <p style={{fontSize:18, color:'var(--site-muted)', lineHeight:1.6, maxWidth:'60ch'}}>Estamos prontos para ajudar com assistência técnica, vendas ou tirar suas dúvidas. Resposta rápida pelo WhatsApp.</p>
          </div>
            ...
            <div style={{display:'grid', gap:32, alignContent:'center'}}>
              ...
              <div>
                <h3 style={{fontSize:13, fontWeight:700, display:'flex', alignItems:'center', gap:8, color:'var(--site-text)', marginBottom:12}}>
                  <MapPin size={16} style={{color:'var(--site-orange)'}} /> Localização
                </h3>
                <div style={{display:'grid', gap:12}}>
                  <a href="https://maps.app.goo.gl/duLv1AeUvQWb81oD8" target="_blank" rel="noopener" style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:12, padding:'16px', borderRadius:12, border:'1px solid var(--site-border)', background:'var(--site-panel)', color:'var(--site-text)', fontSize:14, fontWeight:500, textDecoration:'none'}}>
              ...
              <div style={{borderTop:'1px solid var(--site-border)', paddingTop:24}}>
                ...
                <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:12}}>
                  <a href="https://api.whatsapp.com/send/?phone=5599984599773" target="_blank" rel="noopener" style={{display:'flex', alignItems:'center', gap:10, padding:'0 16px', height:48, borderRadius:12, border:'1px solid var(--site-border)', background:'var(--site-panel)', textDecoration:'none', flex:1}}>
                    ...
                    <span style={{fontSize:13, fontWeight:700, color:'var(--site-text)'}}>+55 99 98459-9773</span>
                  </a>
                  <a href="https://www.instagram.com/jk_importds" target="_blank" rel="noopener" style={{display:'flex', alignItems:'center', gap:10, padding:'0 16px', height:48, borderRadius:12, border:'1px solid var(--site-border)', background:'var(--site-panel)', textDecoration:'none', flex:1}}>
                    ...
                    <span style={{fontSize:13, fontWeight:700, color:'var(--site-text)'}}>@jk_importds</span>
                  </a>
                </div>
              </div>
            </div>
