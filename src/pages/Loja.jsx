      ...
      <section className="store-hero-open">
        <div className="store-hero-grid">
          <div>
            ...
            <h1 className="store-hero-title">iPhones a pronta entrega.</h1>
            <p className="store-hero-lead">Novos e seminovos revisados, com garantia e procedência. Escolha seu aparelho e fale com a JK IMPORTS pelo WhatsApp.</p>
          </div>
          <div className="store-hero-visual store-hero-banner">
            <div className="store-hero-banner-inner">
              <img src="/images/loja.png" alt="Loja JK IMPORTS" />
            </div>
          </div>
        </div>
        <div className="store-hero-benefits">
          <div className="store-benefit">
            ...
            <span>Aparelhos revisados</span>
          </div>
          <div className="store-benefit">
            <Truck size={20} strokeWidth={1.8} />
            <strong>Entrega</strong>
            <span>Local ou envio</span>
          </div>
          <div className="store-benefit">
